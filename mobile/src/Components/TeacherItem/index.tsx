    ...
    return(
        <View style={styles.container}>
            ...
            <Text style={styles.bio}>
                ...
                {'\n'}{'\n'}
                Culpa magni tempora, sit ipsum quaerat quod laborum blanditiis repellendus optio suscipit voluptates perferendis iusto nam, voluptas nostrum, doloribus sed vel. In?
            </Text>
